...
interface UnsetDetailIconProps {
  $width?: string;
  $height?: string;
}

const UnsetDetailIcon = ({ $width, $height }: UnsetDetailIconProps) => {
  ...
  return (
    <svg
      ...
      width={$width || "24px"}
      fill={details ?'var(--color-3)' :'var(--color-2)'}
    >
...
export default UnsetDetailIcon;
